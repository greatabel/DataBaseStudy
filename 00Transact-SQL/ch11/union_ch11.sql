...
---find differences
select * from #set1 s1
where not exists(select * from #set2 s2 where s2.col1 =s1.col1 and s2.col2 =s1.col2 )

--simple use outer join to find differences, this method is bad when too many columns
select s1.*
